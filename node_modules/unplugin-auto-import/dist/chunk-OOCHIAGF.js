...
var _chunkEGAZYO6Mjs = require('./chunk-EGAZYO6M.js');
...
function resolveOptions(options = {}) {
  ...
  const resolved = _chunkEGAZYO6Mjs.__spreadProps.call(void 0, _chunkEGAZYO6Mjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkEGAZYO6Mjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkEGAZYO6Mjs.presets[definition];
