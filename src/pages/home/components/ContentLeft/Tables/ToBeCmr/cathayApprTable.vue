    ...
    <table class="table is-striped-odd is-fullwidth" id="dataTable">
      <StickyThead>
        <tr class="scroll-fix has-text-centered">
          <th>
            <cathay-translate code="Component_cathayApprTable_001" />
          </th>
          <SortingThead sortKey="APLY_NO" :currentSortKey="sortName" :isSortDesc="isSortDesc" :onClickSort="setSort">
            <cathay-translate code="Component_cathayApprTable_002" />
          </SortingThead>
          <th>
            <cathay-translate code="Component_cathayApprTable_003" />
          </th>
          <th>
            <cathay-translate code="Component_cathayApprTable_004" />
          </th>
          <th>
            <cathay-translate code="Component_cathayApprTable_005" />
          </th>
          <SortingThead sortKey="RESOLVE_STATUS" :currentSortKey="sortName" :isSortDesc="isSortDesc" :onClickSort="setSort">
            <cathay-translate code="Component_cathayApprTable_006" />
          </SortingThead>
        </tr>
      </StickyThead>
      <tbody>
        <tr v-for="(theData, index) in cathayData" :key="index">
          ...
          <td class="has-text-centered">
            ...
            <br />
            <cathay-translate code="Component_cathayApprTable_007" /> {{ ': ' + getVNDate(theData.CATHAY_RECEIVER_DATE) }}
          </td>
          <td class="has-text-centered">
            {{ theData.STATUS }}
            <br />
...
<script setup>
  ...
  const cathayData = reactive(props.cmrCathay_mapList);
