<template>
  <div class="is-flex w-100 is-align-items-center limit-width" ref="target">
    ...
    <div v-else :style="styleList" class="dropdown is-editing is-primary is-outline limit-width mr-2"
      @click="onClickOpenModal">
      <div class="dropdown-trigger">
        <button class="button" aria-haspopup="true" aria-controls="dropdown-menu">
          <span class="font-eudc" :class="{ placeholder: showingText === props.placeholder }">{{ showingText
          }}</span><img src="/src/assets/images/icon-add.svg" alt="ARROW DOWN" />
        </button>
      </div>
    </div>
